...
export default function Home() {
    return (
        <div className={"grid"}>
            <div className={"h-[930px] w-full bg-cover object-cover opacity-90 bg-bottom bg-[url('/tm-10.jpg')]"}>
                <div className={"flex justify-center w-full h-full items-center"}>
                    <div className={"grid grid-cols-1 justify-items-center"}>
                        <div className={"font-extralight text-[#FFFFFF] text-[24px] md:text-[36px]"}>WELCOME TO</div>
                        <div className={"font-semibold text-[#FFFFFF] text-[36px] md:text-[64px]"}>SIAM KINNAREE</div>
                        <a className={"text-[#FFFFFF] font-bold border-2 rounded border-[#F4D03F] px-4 py-1 text-[16px] md:text-[24px]"}
            ...
            <div className={"h-[930px] bg-cover opacity-90 bg-center bg-[url('/tm-12.jpg')]"}>
                <div className={"flex justify-center w-full h-full items-center"}>
                    <div className={"grid grid-cols-7 justify-items-center"}>
                        ...
                        <p className={"col-span-3 text-[#FFFFFF] font-extralight border-2 rounded border-[#F4D03F] p-4 text-[12px] md:text-[18px] md:p-12"}>Warm
