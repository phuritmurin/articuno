            ...
            <div className={"divide-y-2 divide-[#F4D03F] space-y-6 md:space-y-16"}>
                <div className={"px-[10%] grid grid-cols-1 space-y-6 md:space-y-16"}>
                    ...
                    <div className={"grid grid-cols-1 space-y-4"}>
                        <div>
                            <div className={"font-normal text-[#F4D03F] text-[18px] md:text-[24px]"}>Traditional Thai Massage</div>
                            <div className={"font-normal text-[#344054] text-[14px] md:text-[18px]"}>Traditional Thai Massage involves
                        ...
                        <div>
                            <div className={"font-normal text-[#F4D03F] text-[18px] md:text-[24px]"}>Foot Reflexology Massage</div>
                            <div className={"font-normal text-[#344054] text-[14px] md:text-[18px]"}>Foot Reflexology Massage is a way
                                of
                        ...
                        <div>
                            <div className={"font-normal text-[#F4D03F] text-[18px] md:text-[24px]"}>Aromatherapy Massage</div>
                            <div className={"font-normal text-[#344054] text-[14px] md:text-[18px]"}>Aromatherapy Massage is a gentle
                        ...
                        <div>
                            <div className={"font-normal text-[#F4D03F] text-[18px] md:text-[24px]"}>Thai Oil Massage</div>
                            <div className={"font-normal text-[#344054] text-[14px] md:text-[18px]"}>Thai Oil Massage is a combination
                                of
                        ...
                        <div>
                            <div className={"font-normal text-[#F4D03F] text-[18px] md:text-[24px]"}>Head Neck and Shoulder Massage
                            </div>
                            <div className={"font-normal text-[#344054] text-[14px] md:text-[18px]"}>Head Neck and Shoulder Massage is
